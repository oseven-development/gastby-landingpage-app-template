module.exports = {
  ...
  app_name: "Caligraf",
  app_price: "Pay per Use",
  app_description: "Handwriting Textrecognition Progressive Web App",
  app_keywords: ["automatic", "gatsbyjs", "app", "landing page"],

  // Personal Info
  your_name: "Philipp Schmid",
  ...
  device_type: "iphone", // Set to "black", "blue", "coral", "white", or "yellow"
